...
<template>
  ...
  <div class="pb-2" >
    <div class="container">
      <!-- search Container -->
      <div class=" shadow w-100 d-flex justify-content-center align-items-center mt-5" style="height: 400px" >
      ...
      <div class="d-flex flex-column gap-3 my-4 shadow px-5 py-5">
        <div class="text-center"> 
          <h3>Title Book</h3>
          <div class="d-flex gap-3 overflow-auto w-100 shadow-sm pb-1">
            <BookCard/>
            <BookCard/>
            <BookCard/>
            <BookCard/>
